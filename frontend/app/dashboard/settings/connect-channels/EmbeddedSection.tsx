...
export default function EmbeddedSection({
  ...
  return (
    <section className="overflow-hidden rounded-[28px] border border-primary-muted bg-white shadow-[0_16px_45px_rgba(28,25,23,0.06)]">
        ...
        <div>
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-br from-[#2e1065] to-primary px-4 py-2.5 font-label text-xs sm:text-sm font-bold text-white shadow-sm transition-all hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-60"
            >
            ...
            <button
              ...
              disabled={!canManage || isBusy}
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-border bg-white px-4 py-2.5 font-label text-xs sm:text-sm font-bold text-ink transition-all hover:bg-surface-subtle hover:border-primary/30 disabled:cursor-not-allowed disabled:opacity-60"
            >
          ...
          <p className="mt-2.5 font-body text-xs text-ink-muted">
      ...
      <div className="border-t border-border bg-surface-subtle/30 p-5 sm:p-7">
        <h3 className="mb-3.5 font-label text-xs font-bold uppercase tracking-wider text-ink-muted">Active Channels</h3>
        ...
        {META_CHANNELS.map(channel => {
          ...
          return (
            <div
              key={channel.id}
              className="flex items-center justify-between gap-3 rounded-xl border border-border bg-white p-3.5 shadow-xs transition-all hover:border-primary/40 hover:shadow-sm"
            >
              <div className="flex min-w-0 items-center gap-3">
                <div className={cn("flex h-9 w-9 shrink-0 items-center justify-center rounded-lg", channel.iconBg)}>
