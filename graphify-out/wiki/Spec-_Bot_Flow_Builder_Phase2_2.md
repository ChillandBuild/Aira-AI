...
- **Pause-on-Reply (4-Channel Inbound Interception)** (4 connections) — `docs/superpowers/specs/2026-05-31-bot-flow-builder-phase2-design.md`
...
- **CAS Guard Against Double-Drive (Optimistic Status Flip)** (2 connections) — `docs/superpowers/specs/2026-05-31-bot-flow-builder-phase2-design.md`
