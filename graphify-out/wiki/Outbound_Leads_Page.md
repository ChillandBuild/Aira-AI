...
- **page.tsx** (33 connections) — `frontend/app/dashboard/outbound-leads/page.tsx`
- **chat-thread.tsx** (21 connections) — `frontend/components/chat-thread.tsx`
- **ChatThread()** (6 connections) — `frontend/components/chat-thread.tsx`
- **supabase** (4 connections) — `frontend/lib/supabase.ts`
- **supabase.ts** (3 connections) — `frontend/lib/supabase.ts`
...
- **getAvatarColor()** (2 connections) — `frontend/components/chat-thread.tsx`
- **getInitials()** (2 connections) — `frontend/components/chat-thread.tsx`
...
- **BroadcastHistoryItem** (1 connections) — `frontend/app/dashboard/outbound-leads/page.tsx`
- **BroadcastTag** (1 connections) — `frontend/app/dashboard/outbound-leads/page.tsx`
...
- [[Conversation List UI]] (9 shared connections)
