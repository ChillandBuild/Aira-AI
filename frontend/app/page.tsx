...
import "./landing.css";
import HeroRipple from "./components/landing/HeroRipple";
...
export default function LandingPage() {
  ...
  // Hero water-ripple on CTA buttons
  ...
  return (
    <div className="landing-page">
      ...
      {/* Continuous river running the full page */}
      <RiverThread />
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 flex justify-between items-center h-[72px]">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <button
              ...
              id="nav-demo-btn"
              className="btn-accent text-sm py-2 px-5 ripple-host"
            >
              Book a Demo
              <ArrowRight size={14} />
            </button>
