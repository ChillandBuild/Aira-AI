  ...
  return (
    <header className="sticky top-0 z-40 h-14 flex items-center justify-end gap-2.5 px-7 bg-[#faf8f5] border-b border-[#e8e3db]">
      <button
        ...
        className="flex items-center gap-1.5 h-[34px] px-3 transition-all text-ink-secondary font-mono text-[13px] font-semibold tracking-wide hover:bg-[#f0ece4] bg-transparent border border-[#e8e3db] rounded-lg"
