...
export function RangePicker({
  ...
  return (
    <div className="flex min-w-max items-center gap-1.5" role="group" aria-label="Reporting period">
      <div className="flex items-center gap-1">
        {PRESET_OPTIONS.map((option) => (
          <button
            ...
            className={`h-9 rounded-lg border px-2.5 font-label text-xs font-semibold transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-violet-200 ${
      ...
      <input
        ...
        className={`h-9 rounded-lg border border-surface-mid bg-[#fcfbf9] px-2 font-body text-xs font-semibold text-on-surface transition-colors hover:border-violet-200 focus:outline-none focus:ring-2 focus:ring-violet-200 ${compact ? "w-[108px]" : "w-[136px]"}`}
      />
